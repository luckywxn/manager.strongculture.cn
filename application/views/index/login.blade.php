...
<symbol id="icon-code" viewBox="0 0 32 32">
    ...
    <span style="display:block;text-align: center;color: red;width: 100%">{{$msg}}</span>
    <form action="/index/UserLogin" id="login_form" method="post" style="height: 669px">
    <section class="login-wrap input-list">
        <ul>
            <li class="">
                <svg class="icon icon-user"><use xlink:href="#icon-user"></use></svg>
                <input type="text" id="username" name="username" placeholder="帐号/手机号/邮箱">
            </li>
            <li class="password-input">
                <svg class="icon icon-password"><use xlink:href="#icon-password"></use></svg>
                <input type="password" id="password" name="passwordhash" placeholder="6-18位大小字母、符号或数字">
                <svg class="icon icon-del" id="j-delPassWord" style="transform-origin: 0px 0px 0px; opacity: 1; transform: scale(1, 1); display: none;"><use xlink:href="#icon-del"></use></svg>
        ...
        <button type="submit" class="red-btn disabled login-button" href="javascript:"><span class="load"></span>登录</button>

        <p class="flex"><a href="#" external="">忘记密码</a><a class="blue" href="index/register">手机注册</a></p>
