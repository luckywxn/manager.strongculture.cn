    ...
    <form data-toggle="ajaxsearch" data-options="{searchDatagrid:$.CurrentNavtab.find('#travelplanlist-table')}">
        <fieldset>
            ...
            <div class="bjui-row col-4">
                ...
                <div class="row-input">
                    <input type="text" name="grade" value="{{$grade or ''}}" placeholder="年级">
                </div>

                <label class="row-label">科目</label>
                <div class="row-input">
                    <input type="text" name="subject" value="{{$subject or ''}}" placeholder="科目">
                </div>
...
<div class="bjui-pageContent clearfix">
    <table class="table table-bordered" id="travelplanlist-table" data-toggle="datagrid" data-options="{
        ...
        dataUrl: 'study/studylistJson',
        dataType: 'json',
        jsonPrefix: 'obj',
        editMode: {dialog:{width:'600',height:'300',title:'学习管理',mask:true}},
        editUrl: '/study/studyedit/id/{sysno}',
        delUrl:'/study/studydeljson',
        delPK:'sysno',
        paging: {pageSize:20},
        ...
        <thead>
            <tr data-options="{name:'sysno'}">
                <th data-options="{name:'grade',align:'center'}">年级</th>
                <th  data-options="{name:'subject',align:'center'}">科目</th>
                <th  data-options="{name:'score',align:'center'}">分数</th>
