<div class="bjui-pageHeader " style="background-color:#fefefe; border-bottom:none;padding: 0;">
    <form data-toggle="ajaxsearch" data-options="{searchDatagrid:$.CurrentNavtab.find('#planlist-table')}">
        <fieldset>
...
<div class="bjui-pageContent clearfix">
    <table class="table table-bordered" id="planlist-table" data-toggle="datagrid" data-options="{
        tableWidth:'99%',
        height: '100%',
        gridTitle : '',
        showToolbar: true,
        toolbarItem: 'add,|,edit,|,del',
        dataUrl: 'travel/travelplanlistJson',
        dataType: 'json',
        jsonPrefix: 'obj',
        editMode: {dialog:{width:'600',height:'300',title:'旅游计划',mask:true}},
        editUrl: '/travel/travelplanedit/id/{sysno}',
        delUrl:'/travel/travelplandeljson',
        delPK:'sysno',
        paging: {pageSize:20},
        ...
        <tr data-options="{name:'sysno'}">
            ...
            <th  data-options="{name:'plantime',align:'center'}">计划时间</th>
