...
<div class="bjui-pageContent clearfix">
    <table class="table table-bordered" id="privilegelist-table" data-toggle="datagrid" data-options="{
        ...
        dataUrl: '/system/privilegetreejson',
        editMode: {dialog:{width:'1000',height:'500',title:'权限管理',mask:true}},
        ...
        <thead>
            <tr data-options="{name:'sysno'}">
                ...
                <th data-options="{name:'privilegename',align:'center',width:200}">权限名称</th>
                ...
                <th data-options="{name:'isdel',align:'center',width:70,render:function(value){return value == '1' ? '×': '√'    }}">是否可用</th>
